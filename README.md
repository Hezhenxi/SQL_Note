...
<a name="3060-1621846615933"></a><a name="rxqh-1705583035276"></a>[一.sql优化原则：](#vc0n-1647601801878)

<a name="msvh-1705583035278"></a>[explain ](#7993-1595249948969)

<a name="3c09-1705583035280"></a>[适合建立索引的情景](#a8li-1647601801879)

<a name="dpjx-1705583035282"></a>[不建或者少建索引](#tzpf-1647601801880)

<a name="ol5i-1705583035284"></a>[对千万级Mysql 数据库建立索引的事项 及 提高性能的 手段](#ib4d-1647601801881)

<a name="powp-1705583035286"></a>[执行一条sql语句的过程](#2jld-1647601801883)

<a name="uyxw-1705583035288"></a>[2.采用二阶段提交的原因(binlog-有/无记录，redolog-prepare/commit)](#enmw-1648713164378)

<a name="uhld-1705583035290"></a>[Crash recovery](#f9ot-1621694746777)

<a name="k4lz-1705583035292"></a>[二.常用sql技巧](#hekl-1647601801884)

<a name="ad8u-1705583035294"></a>[2.1.窗口函数语法](#i9j9-1647601801885)

<a name="3sua-1705583035296"></a>[2.2 连续时间问题](#4n1t-1647601801886)

<a name="4cbs-1705583035298"></a>[tips](#iim8-1696863845970)

<a name="rasw-1705583035300"></a>[1.执行顺序](#fv2q-1698086159246)

<a name="bgx2-1705583035302"></a>[2.子查询位置](#omve-1698086204572)

<a name="wbb3-1705583035304"></a>[3.简洁多表连接](#ym2d-1696735265316)

<a name="1pvm-1705583035306"></a>[4.union与union all](#6dnv-1698086245009)

<a name="gxru-1705583035308"></a>[5.repalec into 与 insert into](#j1na-1698086318830)

<a name="cuzx-1705583035310"></a>[6. truncate 与 delete alter](#qhl3-1698086420800)

<a name="melg-1705583035312"></a>[7.count(email)= count(*) email is not null](#drx4-1698086420953)

<a name="4zxs-1705583035314"></a>[MySQL](#cgnw-1698086318976)

<a name="aczh-1705583035316"></a>[DCL](#x1t2-1696735285622)

<a name="31gg-1705583035318"></a>[-用户管理](#6q0c-1696736466072)

<a name="vvqb-1705583035320"></a>[1．查询用户](#uj4y-1698934973382)

<a name="2syy-1705583035323"></a>[2．创建用户](#wspi-1698934977505)

<a name="vril-1705583035325"></a>[3．修改用户密码](#7nyp-1698934982483)

<a name="xkoa-1705583035327"></a>[4．删除用户](#um15-1698934986587)

<a name="pvc4-1705583035329"></a>[-权限控制](#3nyz-1625216658971)

<a name="x4fz-1705583035331"></a>[1．查询权限](#jbks-1698934999767)

<a name="9atu-1705583035333"></a>[2.   授予权限](#diuh-1698935003460)

<a name="n6dg-1705583035335"></a>[3．撤销权限](#ylog-1698935006832)

<a name="f083-1705583035337"></a>[事务](#sjar-1636598197682)

<a name="zjml-1705583035339"></a>[-事务操作](#wri9-1696837069470)

<a name="lhit-1705583035341"></a>[1.  手动事务操作-开启提交回滚](#acec-1698935098479)

<a name="ucgg-1705583035343"></a>[2.  自动事务](#46eo-1698935204248)

<a name="fllm-1705583035345"></a>[-ACID](#vqlu-1696758438822)

<a name="irrd-1705583035347"></a>[1.  原子性](#x6u4-1698935230037)

<a name="jat3-1705583035349"></a>[2.  一致性](#b0em-1698935233295)

<a name="nlsw-1705583035351"></a>[3.  隔离性](#zspy-1698935235755)

<a name="5mr7-1705583035353"></a>[4.  持久性](#zyul-1698935238660)

<a name="xvdk-1705583035355"></a>[-并发事务问题](#nokq-1696837105831)

<a name="gws9-1705583035357"></a>[1.  脏读](#mrdk-1698935252808)

<a name="3wk7-1705583035359"></a>[2.  不可重复读](#ewhq-1698935269469)

<a name="3qnx-1705583035361"></a>[3.  幻读](#aujz-1698935274920)

<a name="tyvf-1705583035363"></a>[-隔离级别](#yhxf-1696837399326)

<a name="j6qy-1705583035365"></a>[1.  读未提交](#omjq-1698935288286)

<a name="8oq8-1705583035367"></a>[2.  读已提交](#lssb-1698935297866)

<a name="happ-1705583035369"></a>[3.  可重复读](#kwca-1698935302839)

<a name="ljpa-1705583035371"></a>[4.  串行化](#tmef-1698935310086)

<a name="rgwe-1705583035373"></a>[存储引擎](#bht1-1696838153953)

<a name="4f01-1705583035375"></a>[1.  在创建表时，指定存储引擎](#femh-1698935487485)

<a name="tr41-1705583035377"></a>[2.  查看当前数据库支持的存储引擎](#tqfb-1698935493528)

<a name="akd7-1705583035379"></a>[-存储引擎特点](#oglk-1696848529135)

<a name="6xvb-1705583035381"></a>[InnoDB](#6fp3-1696848857758)

<a name="xsda-1705583035383"></a>[1.  介绍](#ox4a-1698935565602)

<a name="mqov-1705583035385"></a>[2.  特点](#onm5-1698935566490)

<a name="mjw8-1705583035387"></a>[3.  文件](#gazm-1698935567481)

<a name="3yzh-1705583035389"></a>[4.  逻辑存储结构](#8h9j-1698935571871)

<a name="wi3d-1705583035391"></a>[MyISAM](#pe25-1696848676613)

<a name="bflw-1705583035393"></a>[1.  介绍](#lrec-1698935670082)

<a name="5dff-1705583035395"></a>[2.  特点](#pbvq-1698935670649)

<a name="sabe-1705583035397"></a>[不支持事务，](#px0q-1705136737676)

<a name="hyph-1705583035399"></a>[不支持外键支持表锁，](#tbyo-1705136742374)

<a name="2920-1705583035401"></a>[不支持行锁访问速度快](#rjv5-1705136742375)

<a name="e8ok-1705583035404"></a>[适合读取密集型，仅读取和插入，少更新和删除](#sbqm-1705136748980)

<a name="jja9-1705583035406"></a>[3.  文件](#yqhc-1698935670650)

<a name="g9zu-1705583035408"></a>[Memory](#secf-1696849511272)

<a name="geyk-1705583035410"></a>[1.  介绍](#nelb-1698935673103)

<a name="nxbp-1705583035412"></a>[2.  特点](#dxmb-1698935673584)

<a name="qbmv-1705583035414"></a>[内存存放](#wax5-1705136830834)

<a name="gkfh-1705583035416"></a>[3.  文件](#qgqo-1698935673585)

<a name="lozc-1705583035418"></a>[-存储引擎选择](#qiek-1696849718446)

<a name="geuv-1705583035420"></a>[1.innodB 要求事务，还包含很多的更新、删除操作](#fjp8-1705136852193)

<a name="4kkt-1705583035422"></a>[2.MyISAM 读取密集型，少更新和删除](#jfs6-1705136882171)

<a name="ohwb-1705583035424"></a>[3.MEMORY 临时表及缓存](#z9ha-1705136893205)

<a name="adhp-1705583035426"></a>[索引](#jrcz-1696850044599)

<a name="ow3d-1705583035428"></a>[1.  介绍](#z7mq-1698935695310)

<a name="aes0-1705583035430"></a>[2.  优缺点](#vjro-1698935699363)

<a name="iulw-1705583035432"></a>[-索引结构](#p6r3-1696858679770)

<a name="tebi-1705583035434"></a>[B树](#jfeb-1696860843491)

<a name="fnlq-1705583035436"></a>[B+数](#9rrd-1697524570983)

<a name="ubox-1705583035438"></a>[1.  与B数区别](#4tqk-1698935751853)

<a name="o2fc-1705583035440"></a>[2.  InnoDB为什么选择B+树](#pzp7-1698935768059)

<a name="xig3-1705583035442"></a>[Hash](#snxg-1697524584075)

<a name="ypdw-1705583035444"></a>[1.  特点](#lu1h-1698935823436)

<a name="m7sr-1705583035446"></a>[2.  存储引擎支持](#peli-1698935826938)

<a name="nsiv-1705583035448"></a>[3.  哈希碰撞问题解决-HashMap结构](#xhlq-1698935848943)

<a name="jea7-1705583035450"></a>[-索引分类](#76bw-1697525778738)

<a name="rerm-1705583035452"></a>[1.  主键索引](#fbur-1698935901887)

<a name="3e8s-1705583035454"></a>[2.  唯一索引](#nzzv-1698935906644)

<a name="uesl-1705583035456"></a>[3.  常规索引](#upau-1698935909493)

<a name="irpl-1705583035458"></a>[4.  全文索引](#rjnv-1698935919240)

<a name="lgdv-1705583035460"></a>[5.  聚集与非聚集](#rmvu-1698935983754)

<a name="gumz-1705583035462"></a>[-3层B+树主键容量](#t1u1-1697527701468)

<a name="byye-1705583035464"></a>[-索引创建](#ju0c-1697527701470)

<a name="snpl-1705583035466"></a>[1.  创建create](#a8zv-1698936024125)

<a name="dzjy-1705583035468"></a>[2.  查看show](#k5x4-1698936028474)

<a name="25gn-1705583035470"></a>[3.  删除drop](#bqtf-1698936031012)

<a name="yfa5-1705583035472"></a>[-SQL性能分析](#rsrr-1697532072447)

<a name="9gtu-1705583035474"></a>[1. SQL执行频率](#9ps1-1697532346408)

<a name="uzaj-1705583035476"></a>[2.  慢查询日志](#epoc-1697532103703)

<a name="chmz-1705583035478"></a>[3.  profile详情-补充未记录到慢查询](#rtzu-1698086024361)

<a name="bhcn-1705583035480"></a>[4.  explain执行计划](#fixj-1697532924763)

<a name="9gu0-1705583035482"></a>[-索引使用规则](#hsyt-1698086053392)

<a name="a1mg-1705583035484"></a>[1.  最左前缀法则(无关顺序，不可跳跃某一列)](#wfva-1698258549870)

<a name="d08p-1705583035486"></a>[2.  范围查询(><右侧失效)](#rhqp-1698258215261)

<a name="uvpk-1705583035489"></a>[3.  索引失效情况1](#noqp-1698259719247)

<a name="mtfp-1705583035491"></a>[.索引列运算(函数操作)](#73m3-1698259958067)

<a name="bani-1705583035493"></a>[.字符串不加引号(隐式转换)](#jfiy-1698259897450)

<a name="8x3h-1705583035495"></a>[.左模糊查询(联想前缀索引)](#ys0a-1698260050292)

<a name="nk0x-1705583035497"></a>[4.  索引失效情况2](#smyy-1698260181918)

<a name="ir7u-1705583035499"></a>[.or连接的条件(都不会引用到，需建立符合索引)](#e8xu-1698260409971)

<a name="07cm-1705583035501"></a>[.数据分布影响(mysql自检，需查大部分数据则走索引)](#4ymt-1698260481408)

<a name="myfu-1705583035503"></a>[5.  SQL提示-指定使用哪个索引](#lm6a-1698260620466)

<a name="ytsn-1705583035505"></a>[6.  索引覆盖&回表查询(节点和叶子节点包含所需数据)](#7kuw-1698261564301)

<a name="omfl-1705583035507"></a>[7.  前缀索引-缩减大文本索引(类似右模糊)](#lloi-1698261747665)

<a name="vwut-1705583035509"></a>[前缀长度(不重复的索引值(选取长度)/记录总数 接近1性能最好)](#f9fa-1705281343312)

<a name="ffzs-1705583035511"></a>[8.  单列索引(mysql选择哪一个)&联合索引(第一列必须存在，建议索引覆盖)](#hbtk-1698263059798)

<a name="udqu-1705583035513"></a>[9.  设计原则](#xqe0-1698350463296)

<a name="zssw-1705583035515"></a>[视图](#6tgn-1698351177866)

<a name="ewc5-1705583035517"></a>[1.  介绍(逻辑表)](#9jqw-1698936202186)

<a name="f4xu-1705583035519"></a>[2.  作用(提供数据给用户,屏蔽底层)](#pgws-1698936204054)

<a name="is0n-1705583035521"></a>[3.  创建查看删除](#bmjn-1698936206457)

<a name="scr5-1705583035523"></a>[锁](#aozc-1698501711461)

<a name="kqdq-1705583035525"></a>[-全局锁](#34q7-1698630097402)

<a name="b9mj-1705583035527"></a>[1.  数据库逻辑备份](#9wq1-1698630617019)

<a name="uyt1-1705583035529"></a>[2.  InnoDB不加锁一致性备份](#1uni-1698630145465)

<a name="xiuf-1705583035531"></a>[快照备份(不加锁)如何保障一致性(快照读,写时复制)](#hzlu-1698632267315)

<a name="py8q-1705583035533"></a>[-表级锁](#nkxl-1705577226591)

<a name="dqlz-1705583035535"></a>[1.  表锁-共享读独占写](#oonk-1698631410993)

<a name="i6zh-1705583035537"></a>[.表共享读锁](#rgnc-1698949909492)

<a name="u8lh-1705583035539"></a>[.表独占写锁](#flt3-1698949914801)

<a name="lrh4-1705583035541"></a>[2.  元数据锁-指表结构(避免DML,DDL冲突)](#mbvi-1698631471760)

<a name="ghrg-1705583035543"></a>[.MDL共享读-curd操作](#vgvr-1698949948193)

<a name="adfm-1705583035545"></a>[.MDL排他写-DDL操作](#m0yt-1698949965870)

<a name="d8pj-1705583035547"></a>[3.  意向锁-行锁表锁冲突提效](#uldg-1698632501087)

<a name="yhu5-1705583035549"></a>[.意向共享（IS）-与表排他写锁互斥，阻塞表锁 lock in share mode](#lihy-1698950039794)

<a name="tdjl-1705583035551"></a>[.意向排他（IX）-锁行后自动添加意向锁阻塞表锁(写读锁) for update](#vokq-1698950064112)

<a name="0a0y-1705583035553"></a>[-行级锁-基于索引项非记录](#lhar-1698630153890)

<a name="gt2t-1705583035555"></a>[1.  行锁/记录锁-不走索引则升级为表锁](#ihem-1698785009242)

<a name="z2z4-1705583035557"></a>[.共享锁（S）](#fqsj-1698950110507)

<a name="iwqq-1705583035559"></a>[.排他锁（X）](#frfu-1698950116296)

<a name="4arp-1705583035562"></a>[2.  间隙锁(索引范围锁)：RR下解决幻读](#092u-1698785365284)

<a name="zawf-1705583035564"></a>[3.  临键 锁](#2cip-1698785368743)

<a name="dyqs-1705583035566"></a>[InnoDB引擎架构](#wv5u-1698934641347)

<a name="6jip-1705583035568"></a>[-逻辑存储结构](#xxte-1698934785966)

<a name="ovj1-1705583035570"></a>[1.  表空间（ibd文件）](#rijc-1698936536741)

<a name="xiar-1705583035572"></a>[2.  段（索引段）](#hcj0-1698936614757)

<a name="zthl-1705583035574"></a>[3.  区（1M,64页 ）](#trpj-1698936634864)

<a name="zsht-1705583035576"></a>[4.  页 （16K-磁盘管理的最小单元，申请4-5区 ）](#pnjg-1698936652874)

<a name="qxtw-1705583035578"></a>[5.  行 （Trx_id-隐藏列，Rall_pointer-Undolog指针）](#o35i-1698936658205)

<a name="7z6b-1705583035580"></a>[-内存架构(内存+磁盘)](#cns1-1698936283052)

<a name="a9bg-1705583035582"></a>[1.  Buffer Pool(减少磁盘IO）](#cbz5-1698936905672)

<a name="n8r3-1705583035584"></a>[2.  Change Buffer(针对于非唯一二级索引页，合并处理减少磁盘IO）](#zlsn-1698937679189)

<a name="vef5-1705583035586"></a>[3.   Adaptive Hash lndex(自动优化对Buffer Pool的查询)](#tt1u-1698937908124)

<a name="lnsa-1705583035588"></a>[4.  Log Buffer（undo,redo）](#qkiu-1698938073529)

<a name="ryr8-1705583035590"></a>[- 磁盘结构](#exmr-1698937415872)

<a name="pohh-1705583035592"></a>[1.  系统表空间（change buffer存储区域）](#0snm-1698939323164)

<a name="rvlk-1705583035594"></a>[2.  表空间（idb文件）](#nryg-1698939327127)

<a name="wvfy-1705583035596"></a>[3.  通用表空间（指定表存放位置）](#juax-1698939336996)

<a name="6nkn-1705583035598"></a>[4.  undo表空间（撤销表空间）](#rbyy-1698942461411)

<a name="uc6q-1705583035600"></a>[5.  临时表空间 （临时表数据）](#yffc-1698942468968)

<a name="netp-1705583035602"></a>[6.  双写缓冲区（双写缓冲区文件，异常恢复）](#rubq-1698942871370)

<a name="jkey-1705583035604"></a>[7. redo log （脏页刷磁盘错误时恢复数据）](#ehmy-1698942904011)

<a name="qkb7-1705583035606"></a>[-后台线程（内存磁盘交互）](#53jq-1698937441986)

<a name="vuw2-1705583035608"></a>[1. Master Thread](#kknd-1698947048446)

<a name="ukn0-1705583035610"></a>[2. IO Thread（AIO异步IO）](#5vjm-1698947052890)

<a name="qrkd-1705583035612"></a>[3.   Purge Thread](#xqib-1698947176665)

<a name="467r-1705583035617"></a>[4.  Page Cleaner Thread](#mdxm-1698947181806)

<a name="wmhi-1705583035619"></a>[InnoDB事务原理](#oqzx-1698943342221)

<a name="drsj-1705583035621"></a>[1.原子性 undolog](#3c9f-1699135695351)

<a name="x6ji-1705583035623"></a>[2.一致性 undolog redolog](#0fpr-1699135700379)

<a name="563g-1705583035625"></a>[3.持久性 redolog](#v24b-1699135704557)

<a name="gdfo-1705583035627"></a>[4.隔离性 锁 MVCC(隐藏字段+undolog版本链+readView) ](#lhxo-1699135708824)

<a name="n3v1-1705583035629"></a>[ -redo log -持久性>WAL先写日志刷磁盘](#3xv9-1698948119439)

<a name="tltd-1705583035631"></a>[-undo log -原子性-回滚-MVCC](#eiip-1698948472859)

<a name="ogol-1705583035634"></a>[MVCC-快照读历史版本](#fj9w-1698951285220)

<a name="snvh-1705583035636"></a>[-基本概念](#bu2g-1698952158239)

<a name="wulu-1705583035638"></a>[1.  当前读（最新版本-加锁的都是）](#acm7-1698953042131)

<a name="s1lk-1705583035640"></a>[2.  快照读 （历史版本-RR下开启事务的第一个Select）](#dtns-1698955322144)

<a name="kvpf-1705583035642"></a>[3. MVCC（维护一个数据的多个版本，提供非阻塞读）](#mi8v-1698956161619)

<a name="4ys3-1705583035644"></a>[-隐藏字段](#p3na-1698952163363)

<a name="wd5m-1705583035646"></a>[1.DB_TRX_ID事务id](#uwuz-1699301956379)

<a name="3knj-1705583035648"></a>[2.DB_ROLL_PTR行指针](#mqaz-1699301965028)

<a name="fxvg-1705583035650"></a>[3.DB_ROw_ID隐藏主键](#thdk-1699301971563)

<a name="7vq9-1705583035652"></a>[-undolog版本链](#e2dp-1698952167493)

<a name="xuw7-1705583035654"></a>[-readview读视图](#qc3g-1698952179087)

<a name="0bvd-1705583035656"></a>[-原理分析(RC级别)](#zysq-1698952216492)

<a name="xuuq-1705583035658"></a>[-原理分析(RR级别)](#ebqu-1698952246400)

<a name="5xar-1705583035660"></a>[管理](#9uz0-1699135234617)

<a name="0f99-1705583035662"></a>[-系统数据库-自带库](#wzzy-1699200494327)

<a name="baww-1705583035664"></a>[-常用工具1-客户端工具](#msjq-1699200469340)

<a name="hkco-1705583035666"></a>[-常用工具2](#mjum-1699200526630)

<a name="swwv-1705583035668"></a>[ 日志](#vl7r-1699215225234)

<a name="mawd-1705583035670"></a>[-错误日志-启动停止错误排查](#v5kp-1699299216424)

<a name="10pv-1705583035672"></a>[-二进制日志-数据恢复(记录DDL+DML)](#diuw-1699299216782)

<a name="kkkm-1705583035674"></a>[二进制日志binlog](#acbh-1705290333621)

<a name="pf4l-1705583035676"></a>[记录格式](#q6ed-1705290350853)

<a name="rabk-1705583035678"></a>[1.STATEMENT(sql)](#jeaj-1705290382107)

<a name="3cjb-1705583035680"></a>[2.ROW(每一行变更前后数据)](#dain-1705290382356)

<a name="1z6a-1705583035682"></a>[3.MIXED(混合)](#fniu-1705290382357)

<a name="ehso-1705583035684"></a>[日志查看](#ngif-1705290356582)

<a name="o3ox-1705583035686"></a>[日志删除(业务繁忙的系统)](#xw5l-1705290359481)

<a name="lb6j-1705583035688"></a>[-查询日志(二进制日志无查询)](#txwu-1699299221578)

<a name="wrth-1705583035690"></a>[-慢查询日志(默认不记录非索引查询)](#hg9x-1699299225236)

<a name="xk8i-1705583035692"></a>[主从复制](#qhvr-1699299111244)

<a name="y4ks-1705583035694"></a>[.重做(二进制日志传到从库并执行)](#mwhp-1704226985478)

<a name="gmnw-1705583035696"></a>[.链状复制(从库复制完后可作为master数据提供)](#ztci-1704227046895)

<a name="sewv-1705583035698"></a>[.复制优点](#xwwm-1704227158643)

<a name="3gyy-1705583035700"></a>[1. 主库挂了，可主从切换(容灾)](#j66j-1704227188661)

<a name="9xqv-1705583035702"></a>[2. 提高性能(读写分离)](#6a7g-1704227190664)

<a name="yotv-1705583035704"></a>[3. 可用从库执行备份(链状复制避免影响主库）](#77es-1704227192883)

<a name="6amt-1705583035706"></a>[.复制原理](#x8hh-1704227339989)

<a name="viop-1705583035708"></a>[1.master事务提交记录binlog](#7moe-1704227349916)

<a name="n9z5-1705583035710"></a>[2.IO THread读binlog到 Relay Log](#tn1l-1704227351412)

<a name="73xe-1705583035713"></a>[3.Sql Thread重做Relay Log](#tpma-1704227352135)

<a name="in7t-1705583035715"></a>[分库分表](#weey-1699299116447)

<a name="l9nv-1705583035717"></a>[. 介绍](#ebw6-1704227729277)

<a name="lyg7-1705583035719"></a>[1.IO瓶颈(解决：OLTP-分库分表 OLAP-列式存储)](#mrjb-1704228084348)

<a name="h88v-1705583035721"></a>[2.CPU瓶颈(聚合函数SQL消耗CPU)](#ltwj-1704228106010)

<a name="qslh-1705583035723"></a>[3.垂直分库(不同库不同表)](#zecd-1704228247899)

<a name="6ppj-1705583035725"></a>[4. 垂直分表(表字段拆分两个表)](#yoxf-1704228972467)

<a name="ru40-1705583035727"></a>[5.水平分库(包含水平分表)](#1dub-1704229862609)

<a name="qc4i-1705583035729"></a>[6.水平分表(数据切分)](#m9vr-1704229867792)

<a name="pzox-1705583035731"></a>[7.实现技术](#mtha-1704230160763)

<a name="xwzm-1705583035733"></a>[shardingJDBC(基于AOP，高性能，改代码)](#c3kv-1704230244807)

<a name="kpxn-1705583035735"></a>[mycat (分库分表中间件，应用无感知)](#9xcv-1704230267627)

<a name="k6ay-1705583035737"></a>[. Mycat概述](#soha-1704227768669)

<a name="y80d-1705583035739"></a>[. Mycat入门](#5sbf-1704227768671)

<a name="rfwj-1705583035741"></a>[. Mycat配置](#o6wi-1704227768673)

<a name="l3i4-1705583035743"></a>[. Mycat分片](#1hvf-1704227768675)

<a name="97tc-1705583035745"></a>[1.范围分片(数字)](#xkif-1704233305364)

<a name="xwk3-1705583035747"></a>[2.取模分片(数字)](#vgou-1704233988586)

<a name="ceun-1705583035749"></a>[3.一致性Hash算法(字符串)](#mzmz-1704234009174)

<a name="vda3-1705583035751"></a>[. Mycat管理及监控 ](#b80d-1704233993440)

<a name="vvec-1705583035753"></a>[读写分离](#n1dc-1699299121860)
...
--B先SELECT \* FROM your\_table WHERE column BETWEEN 3 AND 8 或  insert id=5(无该行记录)，锁3~8间隙, A insert7阻塞而非失败，避免A幻读。
...
<a name="1hvf-1704227768675"></a>**. Mycat分片**
...
<a name="vgou-1704233988586"></a>**2.取模分片(数字)**
