...
<a name="3060-1621846615933"></a><a name="s91x-1706888226730"></a>[一.sql优化原则：](#vc0n-1647601801878)

<a name="ut4q-1706888226732"></a>[explain ](#7993-1595249948969)

<a name="kecz-1706888226734"></a>[适合建立索引的情景](#a8li-1647601801879)

<a name="naww-1706888226736"></a>[不建或者少建索引](#tzpf-1647601801880)

<a name="tqu2-1706888226738"></a>[对千万级Mysql 数据库建立索引的事项 及 提高性能的 手段](#ib4d-1647601801881)

<a name="nvem-1706888226740"></a>[执行一条sql语句的过程](#2jld-1647601801883)

<a name="mgbm-1706888226742"></a>[2.采用二阶段提交的原因(binlog-有/无记录，redolog-prepare/commit)](#enmw-1648713164378)

<a name="zg1z-1706888226744"></a>[Crash recovery](#f9ot-1621694746777)

<a name="ur5y-1706888226746"></a>[二.常用sql技巧](#hekl-1647601801884)

<a name="vrud-1706888226749"></a>[2.1.窗口函数语法](#i9j9-1647601801885)

<a name="5bwr-1706888226751"></a>[2.2 连续时间问题](#4n1t-1647601801886)

<a name="1i9m-1706888226753"></a>[tips](#iim8-1696863845970)

<a name="8t8k-1706888226755"></a>[1.执行顺序](#fv2q-1698086159246)

<a name="jwsu-1706888226757"></a>[2.子查询位置](#omve-1698086204572)

<a name="quoz-1706888226759"></a>[3.简洁多表连接](#ym2d-1696735265316)

<a name="alcf-1706888226761"></a>[4.union与union all](#6dnv-1698086245009)

<a name="mnje-1706888226763"></a>[5.repalec into 与 insert into](#j1na-1698086318830)

<a name="idb8-1706888226765"></a>[6. truncate 与 delete alter](#qhl3-1698086420800)

<a name="cj1q-1706888226767"></a>[7.count(email)= count(*) email is not null](#drx4-1698086420953)

<a name="ylvp-1706888226769"></a>[MySQL](#cgnw-1698086318976)

<a name="jubf-1706888226771"></a>[DCL](#x1t2-1696735285622)

<a name="1m2z-1706888226773"></a>[-用户管理](#6q0c-1696736466072)

<a name="w5mh-1706888226775"></a>[1．查询用户](#uj4y-1698934973382)

<a name="rt5f-1706888226777"></a>[2．创建用户](#wspi-1698934977505)

<a name="fths-1706888226779"></a>[3．修改用户密码](#7nyp-1698934982483)

<a name="ihep-1706888226781"></a>[4．删除用户](#um15-1698934986587)

<a name="eks7-1706888226783"></a>[-权限控制](#3nyz-1625216658971)

<a name="ohhd-1706888226785"></a>[1．查询权限](#jbks-1698934999767)

<a name="ndxu-1706888226787"></a>[2.   授予权限](#diuh-1698935003460)

<a name="l5yy-1706888226789"></a>[3．撤销权限](#ylog-1698935006832)

<a name="pqoq-1706888226791"></a>[事务](#sjar-1636598197682)

<a name="bj2w-1706888226793"></a>[-事务操作](#wri9-1696837069470)

<a name="4mk9-1706888226795"></a>[1.  手动事务操作-开启提交回滚](#acec-1698935098479)

<a name="yzjh-1706888226797"></a>[2.  自动事务](#46eo-1698935204248)

<a name="ct6v-1706888226799"></a>[-ACID](#vqlu-1696758438822)

<a name="yc96-1706888226801"></a>[1.  原子性](#x6u4-1698935230037)

<a name="6rso-1706888226803"></a>[2.  一致性](#b0em-1698935233295)

<a name="tlrk-1706888226805"></a>[3.  隔离性](#zspy-1698935235755)

<a name="zyfl-1706888226807"></a>[4.  持久性](#zyul-1698935238660)

<a name="arel-1706888226809"></a>[-并发事务问题](#nokq-1696837105831)

<a name="xym4-1706888226811"></a>[1.  脏读](#mrdk-1698935252808)

<a name="rwbp-1706888226813"></a>[2.  不可重复读](#ewhq-1698935269469)

<a name="rtzp-1706888226815"></a>[3.  幻读](#aujz-1698935274920)

<a name="9wgq-1706888226817"></a>[-隔离级别](#yhxf-1696837399326)

<a name="n6pz-1706888226819"></a>[1.  读未提交](#omjq-1698935288286)

<a name="xdyu-1706888226821"></a>[2.  读已提交](#lssb-1698935297866)

<a name="cxhk-1706888226824"></a>[3.  可重复读](#kwca-1698935302839)

<a name="gykk-1706888226826"></a>[4.  串行化](#tmef-1698935310086)

<a name="swmg-1706888226828"></a>[存储引擎](#bht1-1696838153953)

<a name="bxbl-1706888226830"></a>[1.  在创建表时，指定存储引擎](#femh-1698935487485)

<a name="kxva-1706888226832"></a>[2.  查看当前数据库支持的存储引擎](#tqfb-1698935493528)

<a name="fvyj-1706888226834"></a>[-存储引擎特点](#oglk-1696848529135)

<a name="xrxj-1706888226836"></a>[InnoDB](#6fp3-1696848857758)

<a name="njr6-1706888226838"></a>[1.  介绍](#ox4a-1698935565602)

<a name="wir7-1706888226840"></a>[2.  特点](#onm5-1698935566490)

<a name="2r0v-1706888226842"></a>[3.  文件](#gazm-1698935567481)

<a name="k4js-1706888226844"></a>[4.  逻辑存储结构](#8h9j-1698935571871)

<a name="rbgu-1706888226846"></a>[MyISAM](#pe25-1696848676613)

<a name="mt84-1706888226848"></a>[1.  介绍](#lrec-1698935670082)

<a name="tycu-1706888226850"></a>[2.  特点](#pbvq-1698935670649)

<a name="xbtx-1706888226852"></a>[不支持事务，](#px0q-1705136737676)

<a name="fxvz-1706888226854"></a>[不支持外键支持表锁，](#tbyo-1705136742374)

<a name="8uwh-1706888226856"></a>[不支持行锁访问速度快](#rjv5-1705136742375)

<a name="e0tc-1706888226858"></a>[适合读取密集型，仅读取和插入，少更新和删除](#sbqm-1705136748980)

<a name="14ld-1706888226860"></a>[3.  文件](#yqhc-1698935670650)

<a name="esjk-1706888226862"></a>[Memory](#secf-1696849511272)

<a name="zlxd-1706888226864"></a>[1.  介绍](#nelb-1698935673103)

<a name="oman-1706888226866"></a>[2.  特点](#dxmb-1698935673584)

<a name="2hx7-1706888226868"></a>[内存存放](#wax5-1705136830834)

<a name="pmsk-1706888226870"></a>[3.  文件](#qgqo-1698935673585)

<a name="ccrk-1706888226872"></a>[-存储引擎选择](#qiek-1696849718446)

<a name="rj0o-1706888226874"></a>[1.innodB 要求事务，还包含很多的更新、删除操作](#fjp8-1705136852193)

<a name="ohnj-1706888226876"></a>[2.MyISAM 读取密集型，少更新和删除](#jfs6-1705136882171)

<a name="mmef-1706888226878"></a>[3.MEMORY 临时表及缓存](#z9ha-1705136893205)

<a name="7jbg-1706888226880"></a>[索引](#jrcz-1696850044599)

<a name="lkyb-1706888226882"></a>[1.  介绍](#z7mq-1698935695310)

<a name="cpkc-1706888226884"></a>[2.  优缺点](#vjro-1698935699363)

<a name="b5dz-1706888226886"></a>[-索引结构](#p6r3-1696858679770)

<a name="jpxt-1706888226888"></a>[B树](#jfeb-1696860843491)

<a name="lcqy-1706888226890"></a>[B+数](#9rrd-1697524570983)

<a name="wuqj-1706888226892"></a>[1.  与B数区别](#4tqk-1698935751853)

<a name="ehuf-1706888226894"></a>[2.  InnoDB为什么选择B+树](#pzp7-1698935768059)

<a name="omfg-1706888226896"></a>[Hash](#snxg-1697524584075)

<a name="eomt-1706888226898"></a>[1.  特点](#lu1h-1698935823436)

<a name="btmd-1706888226900"></a>[2.  存储引擎支持](#peli-1698935826938)

<a name="urfq-1706888226902"></a>[3.  哈希碰撞问题解决-HashMap结构](#xhlq-1698935848943)

<a name="jcye-1706888226905"></a>[-索引分类](#76bw-1697525778738)

<a name="few6-1706888226907"></a>[1.  主键索引](#fbur-1698935901887)

<a name="gwfu-1706888226909"></a>[2.  唯一索引](#nzzv-1698935906644)

<a name="r8ky-1706888226911"></a>[3.  常规索引](#upau-1698935909493)

<a name="9oqw-1706888226913"></a>[4.  全文索引](#rjnv-1698935919240)

<a name="2qbd-1706888226915"></a>[5.  聚集与非聚集](#rmvu-1698935983754)

<a name="2mll-1706888226917"></a>[-3层B+树主键容量](#t1u1-1697527701468)

<a name="dghm-1706888226919"></a>[-索引创建](#ju0c-1697527701470)

<a name="78vn-1706888226921"></a>[1.  创建create](#a8zv-1698936024125)

<a name="spzd-1706888226923"></a>[2.  查看show](#k5x4-1698936028474)

<a name="laoh-1706888226925"></a>[3.  删除drop](#bqtf-1698936031012)

<a name="yxlm-1706888226927"></a>[-SQL性能分析](#rsrr-1697532072447)

<a name="zyq4-1706888226929"></a>[1. SQL执行频率](#9ps1-1697532346408)

<a name="bqou-1706888226931"></a>[2.  慢查询日志](#epoc-1697532103703)

<a name="ycm1-1706888226933"></a>[3.  profile详情-补充未记录到慢查询](#rtzu-1698086024361)

<a name="euzz-1706888226935"></a>[4.  explain执行计划](#fixj-1697532924763)

<a name="eoat-1706888226937"></a>[-索引使用规则](#hsyt-1698086053392)

<a name="yjbz-1706888226939"></a>[1.  最左前缀法则(无关顺序，不可跳跃某一列)](#wfva-1698258549870)

<a name="ch24-1706888226941"></a>[2.  范围查询(><右侧失效)](#rhqp-1698258215261)

<a name="rpzl-1706888226943"></a>[3.  索引失效情况1](#noqp-1698259719247)

<a name="vph9-1706888226945"></a>[.索引列运算(函数操作)](#73m3-1698259958067)

<a name="ktrd-1706888226947"></a>[.字符串不加引号(隐式转换)](#jfiy-1698259897450)

<a name="cema-1706888226949"></a>[.左模糊查询(联想前缀索引)](#ys0a-1698260050292)

<a name="mj5f-1706888226951"></a>[4.  索引失效情况2](#smyy-1698260181918)

<a name="b8vi-1706888226953"></a>[.or连接的条件(都不会引用到，需建立符合索引)](#e8xu-1698260409971)

<a name="zaza-1706888226955"></a>[.数据分布影响(mysql自检，需查大部分数据则走索引)](#4ymt-1698260481408)

<a name="duuj-1706888226957"></a>[5.  SQL提示-指定使用哪个索引](#lm6a-1698260620466)

<a name="lacp-1706888226959"></a>[6.  索引覆盖&回表查询(节点和叶子节点包含所需数据)](#7kuw-1698261564301)

<a name="zknw-1706888226961"></a>[7.  前缀索引-缩减大文本索引(类似右模糊)](#lloi-1698261747665)

<a name="sanl-1706888226963"></a>[前缀长度(不重复的索引值(选取长度)/记录总数 接近1性能最好)](#f9fa-1705281343312)

<a name="8o0g-1706888226965"></a>[8.  单列索引(mysql选择哪一个)&联合索引(第一列必须存在，建议索引覆盖)](#hbtk-1698263059798)

<a name="t9mj-1706888226967"></a>[9.  设计原则](#xqe0-1698350463296)

<a name="ipch-1706888226969"></a>[视图](#6tgn-1698351177866)

<a name="ntoq-1706888226971"></a>[1.  介绍(逻辑表)](#9jqw-1698936202186)

<a name="lyqq-1706888226973"></a>[2.  作用(提供数据给用户,屏蔽底层)](#pgws-1698936204054)

<a name="fxh0-1706888226975"></a>[3.  创建查看删除](#bmjn-1698936206457)

<a name="7zws-1706888226977"></a>[锁](#aozc-1698501711461)

<a name="bf6g-1706888226979"></a>[-全局锁](#34q7-1698630097402)

<a name="sozv-1706888226981"></a>[1.  数据库逻辑备份](#9wq1-1698630617019)

<a name="su9i-1706888226983"></a>[2.  InnoDB不加锁一致性备份](#1uni-1698630145465)

<a name="fpbs-1706888226985"></a>[快照备份(不加锁)如何保障一致性(快照读,写时复制)](#hzlu-1698632267315)

<a name="axhr-1706888226988"></a>[-表级锁](#nkxl-1705577226591)

<a name="vvnr-1706888226990"></a>[1.  表锁-共享读独占写](#oonk-1698631410993)

<a name="3gdu-1706888226992"></a>[.表共享读锁](#rgnc-1698949909492)

<a name="bkgi-1706888226994"></a>[.表独占写锁](#flt3-1698949914801)

<a name="yxlb-1706888226996"></a>[2.  元数据锁-指表结构(避免DML,DDL冲突)](#mbvi-1698631471760)

<a name="j4xl-1706888226998"></a>[.MDL共享读-curd操作](#vgvr-1698949948193)

<a name="klv8-1706888227000"></a>[.MDL排他写-DDL操作](#m0yt-1698949965870)

<a name="tkf0-1706888227002"></a>[3.  意向锁-行锁表锁冲突提效](#uldg-1698632501087)

<a name="tb2y-1706888227004"></a>[.意向共享（IS）-与表排他写锁互斥，阻塞表锁 lock in share mode](#lihy-1698950039794)

<a name="98rz-1706888227006"></a>[.意向排他（IX）-锁行后自动添加意向锁阻塞表锁(写读锁) for update](#vokq-1698950064112)

<a name="6ixo-1706888227008"></a>[-行级锁-基于索引项非记录](#lhar-1698630153890)

<a name="a7es-1706888227010"></a>[1.  行锁/记录锁-不走索引则升级为表锁](#ihem-1698785009242)

<a name="wv1x-1706888227012"></a>[.共享锁（S）](#fqsj-1698950110507)

<a name="ag35-1706888227014"></a>[.排他锁（X）](#frfu-1698950116296)

<a name="nhpa-1706888227016"></a>[2.  间隙锁(索引范围锁)：RR下解决幻读](#092u-1698785365284)

<a name="ds96-1706888227018"></a>[3.  临键 锁](#2cip-1698785368743)

<a name="h5xp-1706888227020"></a>[InnoDB引擎架构](#wv5u-1698934641347)

<a name="mz5g-1706888227022"></a>[-逻辑存储结构](#xxte-1698934785966)

<a name="it4y-1706888227024"></a>[1.  表空间（ibd文件）](#rijc-1698936536741)

<a name="dvtn-1706888227026"></a>[2.  段（索引段）](#hcj0-1698936614757)

<a name="h7nx-1706888227028"></a>[3.  区（1M,64页 ）](#trpj-1698936634864)

<a name="nevh-1706888227030"></a>[4.  页 （16K-磁盘管理的最小单元，申请4-5区 ）](#pnjg-1698936652874)

<a name="dnba-1706888227032"></a>[5.  行 （Trx_id-隐藏列，Rall_pointer-Undolog指针）](#o35i-1698936658205)

<a name="staf-1706888227034"></a>[-内存架构(内存+磁盘)](#cns1-1698936283052)

<a name="aka1-1706888227036"></a>[1.  Buffer Pool(减少磁盘IO）](#cbz5-1698936905672)

<a name="d9kx-1706888227038"></a>[2.  Change Buffer(针对于非唯一二级索引页，合并处理减少磁盘IO）](#zlsn-1698937679189)

<a name="lddi-1706888227040"></a>[3.   Adaptive Hash lndex(自动优化对Buffer Pool的查询)](#tt1u-1698937908124)

<a name="cnxp-1706888227042"></a>[4.  Log Buffer（undo,redo）](#qkiu-1698938073529)

<a name="nuou-1706888227044"></a>[- 磁盘结构](#exmr-1698937415872)

<a name="jksg-1706888227046"></a>[1.  系统表空间（change buffer存储区域）](#0snm-1698939323164)

<a name="fcek-1706888227048"></a>[2.  表空间（idb文件）](#nryg-1698939327127)

<a name="z7eh-1706888227050"></a>[3.  通用表空间（指定表存放位置）](#juax-1698939336996)

<a name="aydz-1706888227052"></a>[4.  undo表空间（撤销表空间）](#rbyy-1698942461411)

<a name="s58u-1706888227054"></a>[5.  临时表空间 （临时表数据）](#yffc-1698942468968)

<a name="btfq-1706888227056"></a>[6.  双写缓冲区（双写缓冲区文件，异常恢复）](#rubq-1698942871370)

<a name="dqd7-1706888227058"></a>[7. redo log （脏页刷磁盘错误时恢复数据）](#ehmy-1698942904011)

<a name="jzxs-1706888227060"></a>[-后台线程（内存磁盘交互）](#53jq-1698937441986)

<a name="iwyu-1706888227063"></a>[1. Master Thread](#kknd-1698947048446)

<a name="dzac-1706888227065"></a>[2. IO Thread（AIO异步IO）](#5vjm-1698947052890)

<a name="vccd-1706888227067"></a>[3.   Purge Thread](#xqib-1698947176665)

<a name="m9dc-1706888227069"></a>[4.  Page Cleaner Thread](#mdxm-1698947181806)

<a name="wlam-1706888227071"></a>[InnoDB事务原理](#oqzx-1698943342221)

<a name="uzg5-1706888227073"></a>[1.原子性 undolog](#3c9f-1699135695351)

<a name="3ltp-1706888227075"></a>[2.一致性 undolog redolog](#0fpr-1699135700379)

<a name="tvhv-1706888227077"></a>[3.持久性 redolog](#v24b-1699135704557)

<a name="vycy-1706888227079"></a>[4.隔离性 锁 MVCC(隐藏字段+undolog版本链+readView) ](#lhxo-1699135708824)

<a name="ucmk-1706888227081"></a>[ -redo log -持久性>WAL先写日志刷磁盘](#3xv9-1698948119439)

<a name="w63k-1706888227083"></a>[-undo log -原子性-回滚-MVCC](#eiip-1698948472859)

<a name="vixw-1706888227085"></a>[MVCC-快照读历史版本](#fj9w-1698951285220)

<a name="ma08-1706888227087"></a>[-基本概念](#bu2g-1698952158239)

<a name="rbg2-1706888227089"></a>[1.  当前读（最新版本-加锁的都是）](#acm7-1698953042131)

<a name="dqis-1706888227091"></a>[2.  快照读 （历史版本-RR下开启事务的第一个Select）](#dtns-1698955322144)

<a name="m08y-1706888227093"></a>[3. MVCC（维护一个数据的多个版本，提供非阻塞读）](#mi8v-1698956161619)

<a name="g4b6-1706888227095"></a>[-隐藏字段](#p3na-1698952163363)

<a name="owfe-1706888227097"></a>[1.DB_TRX_ID事务id](#uwuz-1699301956379)

<a name="wf3s-1706888227099"></a>[2.DB_ROLL_PTR行指针](#mqaz-1699301965028)

<a name="cpkd-1706888227101"></a>[3.DB_ROw_ID隐藏主键](#thdk-1699301971563)

<a name="t5ic-1706888227103"></a>[-undolog版本链](#e2dp-1698952167493)

<a name="1erk-1706888227105"></a>[-readview读视图](#qc3g-1698952179087)

<a name="gxpe-1706888227107"></a>[-原理分析(RC级别)](#zysq-1698952216492)

<a name="zmbr-1706888227109"></a>[-原理分析(RR级别)](#ebqu-1698952246400)

<a name="cvgs-1706888227111"></a>[管理](#9uz0-1699135234617)

<a name="jhgq-1706888227113"></a>[-系统数据库-自带库](#wzzy-1699200494327)

<a name="hnwl-1706888227115"></a>[-常用工具1-客户端工具](#msjq-1699200469340)

<a name="zxxa-1706888227118"></a>[-常用工具2](#mjum-1699200526630)

<a name="qijj-1706888227120"></a>[ 日志](#vl7r-1699215225234)

<a name="pcyh-1706888227122"></a>[-错误日志-启动停止错误排查](#v5kp-1699299216424)

<a name="ml62-1706888227124"></a>[-二进制日志-数据恢复(记录DDL+DML)](#diuw-1699299216782)

<a name="zjjo-1706888227126"></a>[二进制日志binlog](#acbh-1705290333621)

<a name="6xqr-1706888227128"></a>[记录格式](#q6ed-1705290350853)

<a name="vlnx-1706888227130"></a>[1.STATEMENT(sql)](#jeaj-1705290382107)

<a name="5bvj-1706888227132"></a>[2.ROW(每一行变更前后数据)](#dain-1705290382356)

<a name="kybj-1706888227134"></a>[3.MIXED(混合)](#fniu-1705290382357)

<a name="ynvv-1706888227136"></a>[日志查看](#ngif-1705290356582)

<a name="chpj-1706888227138"></a>[日志删除(业务繁忙的系统)](#xw5l-1705290359481)

<a name="ixdb-1706888227140"></a>[-查询日志(二进制日志无查询)](#txwu-1699299221578)

<a name="7amc-1706888227142"></a>[-慢查询日志(默认不记录非索引查询)](#hg9x-1699299225236)

<a name="cybw-1706888227144"></a>[主从复制](#qhvr-1699299111244)

<a name="oox8-1706888227146"></a>[.重做(二进制日志传到从库并执行)](#mwhp-1704226985478)

<a name="wedq-1706888227148"></a>[.链状复制(从库复制完后可作为master数据提供)](#ztci-1704227046895)

<a name="ngot-1706888227150"></a>[.复制优点](#xwwm-1704227158643)

<a name="fdsd-1706888227152"></a>[1. 主库挂了，可主从切换(容灾)](#j66j-1704227188661)

<a name="qvdj-1706888227154"></a>[2. 提高性能(读写分离)](#6a7g-1704227190664)

<a name="d2qb-1706888227156"></a>[3. 可用从库执行备份(链状复制避免影响主库）](#77es-1704227192883)

<a name="dyuh-1706888227159"></a>[.复制原理](#x8hh-1704227339989)

<a name="mbq0-1706888227161"></a>[1.master事务提交记录binlog](#7moe-1704227349916)

<a name="th8c-1706888227163"></a>[2.IO THread读binlog到 Relay Log](#tn1l-1704227351412)

<a name="afrp-1706888227165"></a>[3.Sql Thread重做Relay Log](#tpma-1704227352135)

<a name="lpmk-1706888227167"></a>[分库分表](#weey-1699299116447)

<a name="bjsx-1706888227169"></a>[. 介绍](#ebw6-1704227729277)

<a name="rfoo-1706888227171"></a>[1.IO瓶颈(解决：OLTP-分库分表 OLAP-列式存储)](#mrjb-1704228084348)

<a name="zrac-1706888227173"></a>[2.CPU瓶颈(聚合函数SQL消耗CPU)](#ltwj-1704228106010)

<a name="abuj-1706888227175"></a>[3.垂直分库(不同库不同表)](#zecd-1704228247899)

<a name="5lku-1706888227177"></a>[4. 垂直分表(表字段拆分两个表)](#yoxf-1704228972467)

<a name="xqu9-1706888227179"></a>[5.水平分库(包含水平分表)](#1dub-1704229862609)

<a name="pxbz-1706888227181"></a>[6.水平分表(数据切分)](#m9vr-1704229867792)

<a name="uyoj-1706888227183"></a>[7.实现技术](#mtha-1704230160763)

<a name="dprv-1706888227185"></a>[shardingJDBC(基于AOP，高性能，改代码)](#c3kv-1704230244807)

<a name="d1zp-1706888227187"></a>[mycat (分库分表中间件，应用无感知)](#9xcv-1704230267627)

<a name="x2at-1706888227189"></a>[. Mycat概述](#soha-1704227768669)

<a name="77vw-1706888227191"></a>[. Mycat入门](#5sbf-1704227768671)

<a name="fbc6-1706888227193"></a>[. Mycat配置](#o6wi-1704227768673)

<a name="oruo-1706888227195"></a>[. Mycat分片(范围、散列)](#1hvf-1704227768675)

<a name="o0vk-1706888227197"></a>[1.范围分片(数字)](#xkif-1704233305364)

<a name="8isu-1706888227199"></a>[2.取模分片(数字)-reblancing的反面教材](#vgou-1704233988586)

<a name="kw3o-1706888227201"></a>[3.一致性Hash算法(字符串)](#mzmz-1704234009174)

<a name="xsxs-1706888227203"></a>[. Mycat管理及监控 ](#b80d-1704233993440)

<a name="a7ka-1706888227205"></a>[读写分离(提升读写能力)](#n1dc-1699299121860)

<a name="2b8f-1706888227207"></a>[·一主一从](#kmkz-1706377014485)

<a name="aeic-1706888227209"></a>[·一主一从读写分离](#79ai-1706377057016)

<a name="oyno-1706888227211"></a>[.双主双从(实现读写高可用)](#dpdb-1706377078730)

<a name="f9jr-1706888227213"></a>[.双主双从读写分离](#eunv-1706377057018)
...
<a name="ezup-1702246759036"></a>Binlog 解决数据库crash recovery(系统崩溃宕机)数据恢复，redolog是Innodb 脏页刷入磁盘ibd文件出错时(写入异常)数据恢复。
...
--A先select7=NULL，B insert7-commit, Aselect7依然未null(RR),insert7却失败（告知已有数据）

可重复读并发事务时一般用间隙锁（仅使用RR）解决幻读；--注意：但是需要基于索引项，非索引列就不会有间隙锁，升级为表锁

--A先SELECT \* FROM your\_table WHERE column BETWEEN 3 AND 8 或  insert id=5(无该行记录)，锁3~8间隙, 

B insert7阻塞，A可正常insert成功， 避免A insert失败幻读。
...
<a name="ihem-1698785009242"></a>**1.  行锁/记录锁-不走索引则升级为表锁**
...
SELECT ... LOCK IN SHARE MODE共享锁    需要手动在SELECT之后加LOCK IN SHARE MODE  ---即是行锁也是意向锁

SELECT ... FOR UPDATE排他锁    需要手动在SELECT之后加FOR UPDATE        ---即是行锁也是意向锁
...
<a name="092u-1698785365284"></a>**2.  间隙锁(索引范围锁)：RR下解决幻读**
